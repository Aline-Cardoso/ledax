			...
			<div class="row align-items-center">
					...
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/industrial.jpg" class="img-fluid" alt="Iluminação Industrial">
				...
				<div class="col-lg-4">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/comercial.jpg" class="img-fluid" alt="Iluminação Comercial">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-4">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/publica.jpg" class="img-fluid" alt="Iluminação Pública">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
