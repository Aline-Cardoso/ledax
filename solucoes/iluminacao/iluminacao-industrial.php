			...
			<div class="row align-items-center justify-content-center">
					...
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/high-bay-ultra.jpg" class="img-fluid" alt="High Bay Ultra">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/x-line-hermetica.jpg" class="img-fluid" alt="X-Line Hermética">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/projector-slim.jpg" class="img-fluid" alt="Projector Slim">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/projector-extreme.jpg" class="img-fluid" alt="Projector Extreme">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/high-bay-linear.jpg" class="img-fluid" alt="High Bay Linear">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/projector.jpg" class="img-fluid" alt="Projector">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/high-bay-standard.jpg" class="img-fluid" alt="High Bay Standard">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
