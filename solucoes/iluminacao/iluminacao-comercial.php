			...
			<div class="row align-items-center justify-content-center">
					...
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/perfiled.jpg" class="img-fluid" alt="Perfiled">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/slender-light.jpg" class="img-fluid" alt="Slender Light">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/cannon-sobrepor.jpg" class="img-fluid" alt="Cannon Sobrepor">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/track-light.jpg" class="img-fluid" alt="Track Light">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/cannon-embutir.jpg" class="img-fluid" alt="Cannon Embutir">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/low-bay-slim.jpg" class="img-fluid" alt="Low Bay Slim">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/downlight-round-sobrepor.jpg" class="img-fluid" alt="Downlight Round Sobrepor">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/gas-station.jpg" class="img-fluid" alt="Gas Station">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/gondoled.jpg" class="img-fluid" alt="Gondoled">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/low-bay-pendente.jpg" class="img-fluid" alt="Low Bay Pendente">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/downlight-round-embutir.jpg" class="img-fluid" alt="Downlight Round Embutir">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/low-bay-sobrepor.jpg" class="img-fluid" alt="Low Bay Sobrepor">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/downlight-quad-square.jpg" class="img-fluid" alt="Downlight Quad Square">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/downlight-square.jpg" class="img-fluid" alt="Downlight Square">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<img src="<?=$urlcompleta;?>img/solucoes/produtos/low-bay-embutir.jpg" class="img-fluid" alt="Low Bay Embutir">
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
